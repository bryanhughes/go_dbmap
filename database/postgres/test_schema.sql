...
CREATE TABLE "public".product ( 
	...
	sku                  varchar(100)   ,
	produced             timestamptz DEFAULT current_timestamp  ,
	id                   int   ,
...
CREATE TABLE "public".example_b ( 
	...
	CONSTRAINT idx_example_b_column_a UNIQUE ( column_a ) 
 );
...
CREATE INDEX lookup_name ON test_schema."user" ( first_name, last_name );
...
ALTER TABLE "public".example_c ADD CONSTRAINT fk_example_b_example_c FOREIGN KEY ( column_a ) REFERENCES "public".example_b( column_a );

COMMENT ON CONSTRAINT fk_example_b_example_c ON "public".example_c IS 'This is an example of a foreign relationship that is defined on a column that is not identified by a key. While you can put a unique constraint on the referenced column, this will never formalize in a constraint where you know the referenced table in postgres.';
