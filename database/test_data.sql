...
INSERT INTO example_a (column_a, column_b, column_e, column_g, column_i) VALUES ('Captain', 'Kirk', ARRAY['a', 'b', 'c'], ARRAY[true, false, true], 'one');
-- Postgres will allow inserting an array into a non-array column, but you can not do array operations on it
INSERT INTO example_a (column_a, column_b, column_e, column_g, column_i) VALUES (ARRAY['Captain', 'Jim'], 'Kirk', ARRAY['d', 'e', 'c'], ARRAY[true, false, true], 'two');